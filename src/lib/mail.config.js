...
const getTemplate = (nombre, empresa, codigo) => {
	...
	<tr>
	<td>
	<table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #fceff7; color: #000000; width: 600px;" width="600">
	<tbody>
	<tr>
