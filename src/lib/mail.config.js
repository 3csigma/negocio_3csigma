...
const informeDiagnosticoHTML = (nombre) => {
	return `
	<!DOCTYPE html>
...
<tr>
<td>
<table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #812082; background-image: url('https://3csigma.com/app_public_files/emails_consultor/Nuevo-informe-cargado_01.jpg'); background-repeat: no-repeat; background-size: cover; color: #000000; width: 600px;" width="600">
<tbody>
<tr>
<td class="column column-1" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; padding-top: 0px; padding-bottom: 0px; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;" width="100%">
...
<tr>
<td>
<h1 style="margin: 0; color: #8a3c90; font-size: 27px; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; line-height: 120%; text-align: center; direction: ltr; font-weight: 700; letter-spacing: normal; margin-top: 0; margin-bottom: 0;"><span class="tinyMce-placeholder">Tu consultor ha cargado un nuevo informe de diagnóstico de negocio</span></h1>
</td>
</tr>
</table>
...
<tr>
<td>
<div style="color:#101112;font-size:14px;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-weight:400;line-height:200%;text-align:center;direction:ltr;letter-spacing:0px;mso-line-height-alt:28px;">
